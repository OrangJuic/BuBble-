...
?>
  ...
  <nav aria-label="breadcrumb" style="padding: 0.5em;">
    <ol class="breadcrumb pt-4 " style="font-size: 2vw;">
...
<div class="sidebar mb-4 mt-3 col-md-3">
  <?php ?>
  <form action="drugstore.php" method="get" id="search" name="search" class="d-flex">
    <div class="input-group">
      <input type="text " name="search_name" id="search_name" class="form-control docline-three" style="border-radius: 0;" placeholder="Search..." aria-label="Search" size="30" value="<?php echo (isset($_GET['search_name']))?$_GET['search_name']:'';?>"required>
